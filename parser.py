...
class Parser:
    ...
    def _declaration_sequence(self) -> Optional[ASTNode]:
        """<declaration_sequence> -> <declaration_sequence><declaration> | <declaration> | ??"""
    ...
    def _factor(self) -> Optional[ASTNode]:
        ...
        if self._match(TokenType.IDENTIFIER):
            ...
            self.errors.append(f"Expected identifier, number, or '(' at line {self.current_token.line if self.current_token else '?'}")
            return None
    ...
    def print_ast(self):
        ...
        if self.ast:
            ...
            print("No abstract syntax tree generated.")
    ...
    def print_errors(self):
        ...
        if self.errors:
            ...
            print("Syntax analysis completed, no errors found.")
